...
TEST(NumericCastTest, SignedToSigned) {
  ...
  // Casting int64_t [-9223372036854775808, 9223372036854775807] to int32_t [-2147483648, 2147483647]
  // Incorrect casts
  EXPECT_THROW(numeric_cast<std::int32_t>(-2147483648LL - 1LL), std::runtime_error);
  EXPECT_THROW(numeric_cast<std::int32_t>(2147483647LL + 1LL), std::runtime_error);
  EXPECT_THROW(numeric_cast<std::int32_t>(-9223372036854775807LL - 1LL), std::runtime_error);
  EXPECT_THROW(numeric_cast<std::int32_t>(9223372036854775807LL), std::runtime_error);
  // Correct casts
  EXPECT_EQ(numeric_cast<std::int32_t>(-2147483648LL), -2147483648);
  EXPECT_EQ(numeric_cast<std::int32_t>(-2147483647LL), -2147483647);
  EXPECT_EQ(numeric_cast<std::int32_t>(2147483646LL), 2147483646);
  EXPECT_EQ(numeric_cast<std::int32_t>(2147483647LL), 2147483647);

  // Casting int32_t [-2147483648, 2147483647] to int8_t [-128, 127]
  // Incorrect casts
