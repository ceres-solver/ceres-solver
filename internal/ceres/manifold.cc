...
bool Quaternion::Plus(const double* x,
                      const double* delta,
                      double* x_plus_delta) const {
  QuaternionPlusImpl<QuaternionOrder>(x, delta, x_plus_delta);
  return true;
}

bool Quaternion::PlusJacobian(const double* x, double* jacobian) const {
  QuaternionPlusJacobianImpl<QuaternionOrder>(x, jacobian);
  return true;
}
...
bool Quaternion::Minus(const double* y,
                       const double* x,
                       double* y_minus_x) const {
  QuaternionMinusImpl<QuaternionOrder>(y, x, y_minus_x);
  return true;
}

bool Quaternion::MinusJacobian(const double* x, double* jacobian) const {
  QuaternionMinusJacobianImpl<QuaternionOrder>(x, jacobian);
  return true;
}
