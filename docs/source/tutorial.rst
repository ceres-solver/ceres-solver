...
.. NOTE::
   ...
   This chapter is devoted to bounds constrained robustified
   non-linear least squares problems. If you are interested in more
   general problems, please see :ref:`chapter-gradient_problem_solver`
   for a tutorial introduction and API reference.
