...
possible. The use of C++ templates makes automatic differentiation
...
and computing its analytic Jacobian is a bit of a pain and automatic
differentiation makes things simple here. The function
