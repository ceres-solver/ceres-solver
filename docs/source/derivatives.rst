...
provide derivatives to the solver. She can compute them using:
 ...
 1. :ref:`section-analytic_derivatives`: The user figures out the
    derivative herself, by hand or using a math tool, and implements it
    in the CostFunction.
...
And for the impatient amongst you, here is some high level advice:
 ...
 2. In rare cases it maybe worth using
...
fit this data, i.e., find :math:`b_1, b_2, b_3` and :math:`b_4` that
...
true. Automatic differentiation that we will talk about in more detail
...
Two things stand out in the above graph:
 ...
 1. Forward differences is not a great method for evaluating
    derivatives.
 2. Central differences converges much more quickly to a more accurate
    estimate of the derivative with decreasing step size (from right
    to left).
...
Extrapolation* to the problem of differentiation. This is also known as
*Ridders' Method*.
