...
.. function:: void SetEvaluationCallback(EvaluationCallback* callback, Ownership ownership)

   TODO:: This needs to be updated and elaborated.

   If given, :member:`EvaluationCallback::PrepareForEvaluation` gets
   called before Ceres evaluates the residuals and/or Jacobians.
