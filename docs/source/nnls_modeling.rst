...
-----------------------------------------------
   ...
   add two additional lines to your ``CMakeLists.txt``. Without the codegen your
   ...
   as a dependecy to the executable. The name of the output target is idendical
   ...
   .. code-block:: cmake
    ...
    # Link ceres and the generater target to the executable
    target_link_libraries(codegen_helloworld ceres HelloWorldCostFunction)
