...
.. class:: EvaluationCallback
   ...
   calling ``PrepareForEvaluation``, Ceres will update the user's
   parameter blocks to the values that will be used for evaluating the
   cost functions. These values are are fixed until the next call to
