...
#. ``-DBUILD_DOCUMENTATION=ON``: Use this flag to build Ceres documentation. In
   addition, ``make ceres_docs`` can be used to build only the documentation.
...
Note that this can be used to have multiple versions of Ceres installed locally.
