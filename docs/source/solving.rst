...
.. member:: double Solver::Options::inner_itearation_tolerance
   ...
   Once the relative decrease in the objective function drops below
   ``inner_iteration_tolerance``, the use of inner iterations in
   subsequent trust region minimizer iterations is disabled.
...
.. function:: bool ParameterBlockOrdering::AddElementToGroup(const double* element, const int group)
   ...
   value indicates if adding the element was a success.  bool
