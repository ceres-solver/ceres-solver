...
at Google since 2010. Ceres can solve two kinds of problems.

1. Bounds constrained, robustified `non-linear least squares`_
   problems.
2. Gradient based general unconstrained optimization problems.
...
* Read the :ref:`chapter-tutorial`, browse the chapters
  :ref:`chapter-nnls_modeling` and the :ref:`chapter-nnls_solving`.
