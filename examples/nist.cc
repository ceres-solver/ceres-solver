...
int main(int argc, char** argv) {
  ...
  RegressionDriver<Bennet5,  1, 3>(FLAGS_nist_data_dir + "/Bennett5.dat", options);
  RegressionDriver<BoxBOD,   1, 2>(FLAGS_nist_data_dir + "/BoxBOD.dat",   options);
  RegressionDriver<Chwirut,  1, 3>(FLAGS_nist_data_dir + "/Chwirut1.dat", options);
  RegressionDriver<Chwirut,  1, 3>(FLAGS_nist_data_dir + "/Chwirut2.dat", options);
  RegressionDriver<DanWood,  1, 2>(FLAGS_nist_data_dir + "/DanWood.dat",  options);
  RegressionDriver<Gauss,    1, 8>(FLAGS_nist_data_dir + "/Gauss1.dat",   options);
  RegressionDriver<Gauss,    1, 8>(FLAGS_nist_data_dir + "/Gauss2.dat",   options);
  RegressionDriver<Gauss,    1, 8>(FLAGS_nist_data_dir + "/Gauss3.dat",   options);
  RegressionDriver<Lanczos,  1, 6>(FLAGS_nist_data_dir + "/Lanczos1.dat", options);
  RegressionDriver<Lanczos,  1, 6>(FLAGS_nist_data_dir + "/Lanczos2.dat", options);
  RegressionDriver<Lanczos,  1, 6>(FLAGS_nist_data_dir + "/Lanczos3.dat", options);
  RegressionDriver<Hahn1,    1, 7>(FLAGS_nist_data_dir + "/Hahn1.dat",    options);
  RegressionDriver<Kirby2,   1, 5>(FLAGS_nist_data_dir + "/Kirby2.dat",   options);
  RegressionDriver<MGH09,    1, 4>(FLAGS_nist_data_dir + "/MGH09.dat",    options);
  RegressionDriver<MGH10,    1, 3>(FLAGS_nist_data_dir + "/MGH10.dat",    options);
  RegressionDriver<MGH17,    1, 5>(FLAGS_nist_data_dir + "/MGH17.dat",    options);
  RegressionDriver<Misra1a,  1, 2>(FLAGS_nist_data_dir + "/Misra1a.dat",  options);
  RegressionDriver<Misra1b,  1, 2>(FLAGS_nist_data_dir + "/Misra1b.dat",  options);
  RegressionDriver<Misra1c,  1, 2>(FLAGS_nist_data_dir + "/Misra1c.dat",  options);
  RegressionDriver<Misra1d,  1, 2>(FLAGS_nist_data_dir + "/Misra1d.dat",  options);
  RegressionDriver<Nelson,   1, 3>(FLAGS_nist_data_dir + "/Nelson.dat",   options);
  RegressionDriver<Roszman1, 1, 4>(FLAGS_nist_data_dir + "/Roszman1.dat", options);
  RegressionDriver<Rat42,    1, 3>(FLAGS_nist_data_dir + "/Rat42.dat",    options);
  RegressionDriver<Rat43,    1, 4>(FLAGS_nist_data_dir + "/Rat43.dat",    options);
  RegressionDriver<Thurber,  1, 7>(FLAGS_nist_data_dir + "/Thurber.dat",  options);
