...
// the global coordinates with respect to the local coordinates is large for the
...
struct MarginalizationOptions {
  ...
  // marginal information is not assumed to be full-rank.
...
bool MarginalizeOutVariables(
    ...
    Problem* problem,
    ResidualBlockId* marginalizatio_prior_id,
